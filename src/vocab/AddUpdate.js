    ...
    return (
        <div className="popUp" style={{ display: showPopUp ? 'block' : 'none' }}>
            <div className="addBox">
                <header>
                    <h2>{editable ? 'Update' : 'Add New'} Vocab</h2>
                ...
                <main>
                    <ul>
                        ...
                        <li>
                            <label htmlFor="eg">Example</label>
                            <textarea id="eg" value={data.eg} onChange={handleChange} rows='3'> </textarea>
                        </li>
                    </ul>
                </main>
                <footer>
                    <button onClick={() => setData(initialVal)}>Reset</button>
                    <button type='button' onClick={handleSubmit}>{editable ? 'Update' : 'Add'} Vocab</button>
                </footer>
            </div>
        </div>
    )
